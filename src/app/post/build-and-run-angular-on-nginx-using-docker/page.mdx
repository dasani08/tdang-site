...
At line `85`, the nginx server will return the application's host page (index.html) when asked for a file that it does not have. All routes must fall back to index.html
